...
function MainApp() {
  ...
  const bgMain = isDefaultTheme 
    ...
    : '';
  const bgMainStyle = !isDefaultTheme ? { backgroundColor: themeColors.background } : {};
  
  const bgCard = isDefaultTheme
    ? (darkMode ? 'bg-gray-800' : 'bg-white')
    : '';
  const bgCardStyle = !isDefaultTheme ? { backgroundColor: themeColors.card } : {};
  ...
  const inputBg = isDefaultTheme 
    ...
    : '';
  const inputBgStyle = !isDefaultTheme ? { backgroundColor: themeColors.card } : {};
